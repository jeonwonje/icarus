...
3. Fill in `.env`: bot token, the three channel chat ids, Canvas creds, `OUTLOOK_PST_PATH`, the OAuth token.
...
2. From the **personal** Telegram channel, send "hello" — expect a grounded reply.
